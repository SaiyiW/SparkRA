...
public class Configuration implements Serializable
{
	...
	private boolean star1onLocal;
	private String star1onLocalPath;
	...
	{	
		try
		{
			...
			star1onLocalPath = correctFolderName(emptyIfTagDoesntExist(document,"STAR-1-onLocal"));
			if((star1onLocalPath=="")||(star1onLocalPath=="false/"))
				star1onLocal = false;
			else star1onLocal = true;
	...
	public boolean getSTAR1onLocal(){
		return star1onLocal;
	}

	public String getSTAR1LocalPath(){
		return star1onLocalPath;
	}
